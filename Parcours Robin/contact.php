    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=League+Spartan:wght@400;600&family=Sean+Slab:wght@400;800&display=swap" rel="stylesheet">
        <!-- Font Library - Sean Slab -->
        <style>
        </style>
    </head>
    <body>
