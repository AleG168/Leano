...
<head>
  ...
  <meta
    name="description"
    content="Visualisez nos étapes de design produit à travers une frise interactive à cartes emboîtées. Chaque carte illustre une étape, de l'intention à la livraison. Bretagne – Lannion – Trégor."
  />
    ...
    <div class="timeline-container">
      ...
      <div class="card-container">
        <div class="card card-t1">
          <div class="card-content">
            <h3>1. Définition du problème<br>& cadrage</h3>
            <p>Objectif : comprendre le contexte et les enjeux du projet.</p>
          </div>
          <div class="card-description"></div>
        </div>
        <div class="card-photo-block">
          <img src="assets/Démarche/T3.jpg" alt="Photo pour l'étape T1" class="demarche-small-img" />
      ...
      <div class="card-container">
        <div class="card card-t2">
          <div class="card-content">
            <h3>2. Idéation<br />& Exploration créative</h3>
        ...
        <div class="card-photo-block">
          <img src="assets/Démarche/T3.jpg" alt="Photo pour l'étape T2" class="demarche-small-img" />
          <div class="photo-overlay">
            <p class="overlay-text">
      ...
      <div class="card-container">
        <div class="card card-t3">
          <div class="card-content">
            <h3>3. Design <br />& Développement de concepts</h3>
        ...
        <div class="card-photo-block">
          <img src="assets/Démarche/T3.jpg" alt="Photo pour l'étape T3" />
          <div class="photo-overlay">
            <p class="overlay-text">
              Modélisation 3D (CAO)<br />
              Définition formelle, ergonomique et fonctionnelle<br />
      ...
      <div class="card-container">
        ...
        <div class="card-photo-block">
          <img src="assets/Démarche/T3.jpg" alt="Photo pour l'étape T4" />
          <div class="photo-overlay">
            <p class="overlay-text">
              Réalisation de prototypes (fonctionnels, esthétiques ou interactifs)<br />
              Tests utilisateurs (usage, ergonomie, perception)<br />
      ...
      <div class="card-container">
        ...
        <div class="card-photo-block">
          <img src="assets/Démarche/T3.jpg" alt="Photo pour l'étape T5" />
          <div class="photo-overlay">
            <p class="overlay-text">
              Finalisation des fichiers techniques (plans, matériaux, tolérances)<br />
              Suivi de l'outillage, des tests pré-séries<br />
      ...
      <div class="card-container">
        <div class="card card-t6">
          <div class="card-content">
            <h3>6. Communication <br />& Valorisation</h3>
        ...
        <div class="card-photo-block">
          <img src="assets/Démarche/T3.jpg" alt="Photo pour l'étape T6" />
          <div class="photo-overlay">
            <p class="overlay-text">
              Création de visuels de présentation / storytelling<br />
              Vidéos 3D, mises en situation produit<br />
