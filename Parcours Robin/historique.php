...
<?php include 'navbar.php'; ?>
  <main>
    <div class="content">
      ...
      <section id="about" class="section about animate-section">
    ...
    <section class="section skills-full-bg" id="skills">
      <div class="container">
        <h2>Expertises</h2>
        <div class="skills-grid">
          <div class="skill-card animate-card">
    ...
    <section class="highlight animate-section">
      <div class="container">
        <h2>Ma mission</h2>
  ...
  <script>
    ...
    document.querySelectorAll('.animate-section, .animate-card, .animate-item').forEach((el) => {
      observer.observe(el);
    });
  </script>
</body>
