...
<style>
  /* Alignement logo : mentions-legales.php
     header.Navbar_centrer et .legal-container ont tous deux max-width:1200px margin:auto.
     Logo : padding-left = padding du legal-container = 2rem = 32px.
     Social icons : margin-right 0 (le wrapper centré gère les marges). */
  .navbar-logo-offset   { padding-left: 32px !important; }
