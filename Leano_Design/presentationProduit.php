...
<style>
  /*
   * Alignement logo : presentationProduit.php
   * .alignementPresentationProduit { margin-left: 219px } est fixe dans presentationProduit.css.
   * Le logo doit correspondre à cette même valeur.
   * Sur mobile (<992px) : annuler le margin-left fixe pour éviter le débordement.
   */
  @media (max-width: 991px) {
    .navbar-logo-offset { padding-left: 12px !important; }
    .alignementPresentationProduit { margin-left: 0 !important; padding: 0 16px !important; }
    .NavPresentationProduit { margin-top: 0 !important; margin-bottom: 10px !important; }
  }
  @media (min-width: 992px)  { .navbar-logo-offset { padding-left: 219px !important; } }
</style>
</head>
<body>
