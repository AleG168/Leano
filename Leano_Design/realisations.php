...
<style>
  /* Alignement logo : realisations.php
     header { padding: 20px 50px } → on annule tout le padding du header wrapper.
     Le navbar a déjà py-2 pour son propre espacement interne. */
