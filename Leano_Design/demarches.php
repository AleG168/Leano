...
<style>
  /*
   * Alignement logo : demarches.php — même formule que header et timeline-container.
   * Plafonnée à 120px pour éviter les décalages excessifs sur grands écrans.
   */
  @media (max-width: 575px)  { .navbar-logo-offset { padding-left: 20px !important; } }
  @media (min-width: 576px)  { .navbar-logo-offset { padding-left: max(20px, min(120px, calc((100vw - 540px)  / 2 + 12px))) !important; } }
  @media (min-width: 768px)  { .navbar-logo-offset { padding-left: max(20px, min(120px, calc((100vw - 720px)  / 2 + 12px))) !important; } }
  @media (min-width: 992px)  { .navbar-logo-offset { padding-left: max(20px, min(120px, calc((100vw - 960px)  / 2 + 12px))) !important; } }
  @media (min-width: 1200px) { .navbar-logo-offset { padding-left: max(20px, min(120px, calc((100vw - 1140px) / 2 + 12px))) !important; } }
  @media (min-width: 1400px) { .navbar-logo-offset { padding-left: max(20px, min(120px, calc((100vw - 1320px) / 2 + 12px))) !important; } }
</style>
</head>
