...
<style>
  /*
   * Alignement logo : historique.php
   * Bootstrap CSS se charge APRÈS historique.css et écrase ses règles .container.
   * → Bootstrap applique ses propres max-widths + padding de 12px.
   * On utilise donc la même formule que toutes les autres pages avec .container.
   */
  @media (max-width: 575px)  { .navbar-logo-offset { padding-left: 12px !important; } }
  @media (min-width: 576px)  { .navbar-logo-offset { padding-left: calc((100vw - 540px)  / 2 + 12px) !important; } }
  @media (min-width: 768px)  { .navbar-logo-offset { padding-left: calc((100vw - 720px)  / 2 + 12px) !important; } }
  @media (min-width: 992px)  { .navbar-logo-offset { padding-left: calc((100vw - 960px)  / 2 + 12px) !important; } }
  @media (min-width: 1200px) { .navbar-logo-offset { padding-left: calc((100vw - 1140px) / 2 + 12px) !important; } }
  @media (min-width: 1400px) { .navbar-logo-offset { padding-left: calc((100vw - 1320px) / 2 + 12px) !important; } }
</style>
</head>
